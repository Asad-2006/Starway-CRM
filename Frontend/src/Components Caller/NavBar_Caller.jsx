      ...
      <header className="p-4 lg:px-9 sticky top-0 flex justify-between items-center bg-white z-50 shadow-md relative">
        ...
        <div className="hidden md:block">
          <button
            ...
            className="w-22 h-10 rounded-sm cursor-pointer text-white bg-indigo-600 hover:bg-[#2636ee] px-4 hover:bg-red-500 hover:text-white hover:scale-110 transition duration-300 ease-in-out"
          >
            Logout
          </button>
        </div>
